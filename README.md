...
- [**Use Custom Tuning Profile**] - There are 2 preset tuning profiles which are automatically selected based on the vehicle driven (CAN or CANFD). Toggling this parameter will enable custom tuning values for path_angle.
