...
ConfigDrivenConfirmationDialog::ConfigDrivenConfirmationDialog(const QString &prompt_text,
...
ConfigDrivenFullScreenDialog::ConfigDrivenFullScreenDialog(QWidget *parent) : QDialog(parent) {
...
void ConfigDrivenFullScreenDialog::setupContent(const QString& title, const QString& content) {
...
// config_driven_dialogs.cc (continued)

void ConfigDrivenFullScreenDialog::setupFullscreen() {
...
#ifdef QCOM2
void ConfigDrivenFullScreenDialog::setupWaylandSurface() {
...
QString ConfigDrivenFullScreenDialog::getDialogStyle() const {
    return R"(
        QDialog {
...
ConfigDrivenCommandDialog::ConfigDrivenCommandDialog(QWidget *parent)
    : ConfigDrivenFullScreenDialog(parent), process(nullptr) {
}

void ConfigDrivenCommandDialog::setupCommandUI(const QString& title) {
    ...
    connect(killButton, &QPushButton::clicked, this, &ConfigDrivenCommandDialog::killProcess);
    connect(closeButton, &QPushButton::clicked, this, &QDialog::accept);
}

void ConfigDrivenCommandDialog::executeCommand(const QString& command, const QString& title,
    ...
    connect(process, &QProcess::readyReadStandardOutput, this, &ConfigDrivenCommandDialog::handleProcessOutput);
    connect(process, &QProcess::readyReadStandardError, this, &ConfigDrivenCommandDialog::handleProcessError);
    connect(process, QOverload<int, QProcess::ExitStatus>::of(&QProcess::finished),
            this, &ConfigDrivenCommandDialog::handleProcessFinished);
...
void ConfigDrivenCommandDialog::setupActionButtons(const QJsonArray& actionButtons) {
...
void ConfigDrivenCommandDialog::handleProcessOutput() {
    QString output = QString::fromUtf8(process->readAllStandardOutput());
    outputText->append(output);
}

void ConfigDrivenCommandDialog::handleProcessError() {
    QString error = QString::fromUtf8(process->readAllStandardError());
    outputText->append("<span style='color: #ff7c30;'>" + error.toHtmlEscaped() + "</span>");
}

void ConfigDrivenCommandDialog::handleProcessFinished(int exitCode, QProcess::ExitStatus exitStatus) {
...
void ConfigDrivenCommandDialog::killProcess() {
...
QPushButton* ConfigDrivenCommandDialog::createActionButton(const QJsonObject& buttonObj) {
...
QString ConfigDrivenCommandDialog::getButtonStyle(const QJsonObject& style) const {
