...
def setup_safety_helpers(ffi):
  ...
  int get_desired_path_angle_last();
  void set_desired_path_offset_last(int t);
  int get_desired_path_offset_last();
  void set_desired_curvature_rate_last(int t);
  int get_desired_curvature_rate_last();
...
class PandaSafety(Protocol):
  ...
  # start required for test_ford.py
  def set_desired_path_angle_last(self, t: int) -> None: ...
  def get_desired_path_angle_last(self) -> int: ...
  def set_desired_path_offset_last(self, t: int) -> None: ...
  def get_desired_path_offset_last(self) -> int: ...
  def set_desired_curvature_rate_last(self, t: int) -> None: ...
  def get_desired_curvature_rate_last(self) -> int: ...
  # end - required for test_ford.py
