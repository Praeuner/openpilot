...
def create_lkas_ui_msg(packer, CAN: CanBus, main_on: bool, enabled: bool, steer_alert: bool, send_hands_free_msg: bool, hands: int, hud_control,
                       stock_values: dict):
  """
  ...
  if send_hands_free_msg:
    hands_on_wheel_dsply = hands
  else:
