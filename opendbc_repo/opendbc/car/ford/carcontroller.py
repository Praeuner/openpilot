...
class CarController(CarControllerBase):
  def __init__(self, dbc_names, CP, CP_SP):
    ...
    self.path_angle_filter_samples = 1 # number of samples to use for the moving average filter
    ...
    self.path_angle_k_p_v = [0.01, 0.01]  # corresponding k_p values
    self.path_angle_k_i = 1.0
